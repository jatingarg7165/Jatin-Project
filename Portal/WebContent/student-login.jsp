...
<h1 class="class1">Student Login Page</h1><br><br>

<form action="login" method="post">
	<p class="class2">  Student Id:<input type="text" name="id"><br><br>
...
<h2 class="class2"><a href="student-register.jsp">Registration Page</a></h2>
</body>
</html>
