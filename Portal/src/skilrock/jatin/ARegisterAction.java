...
public class ARegisterAction extends ActionSupport
{
	private static final long serialVersionUID = 6973465299446114035L;

private String name,email,gender,password,con_password,fname,mname,address,number;
private int id;
